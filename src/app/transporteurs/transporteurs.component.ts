...
export class TransporteursComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit(): void {
    this.getAllEmployes();
    this.matPaginatorIntl.itemsPerPageLabel="Transporteurs par page";
  }
  ...
  getAllEmployes(){
       this.authService.listTransporteurs().subscribe((res:any)=>{
