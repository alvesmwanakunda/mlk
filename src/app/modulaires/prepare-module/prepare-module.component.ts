...
@Component({
  selector: 'app-prepare-module',
  templateUrl: './prepare-module.component.html',
  styleUrls: ['./prepare-module.component.scss']
})
export class PrepareModuleComponent implements OnInit, AfterViewInit {
